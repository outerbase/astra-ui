...
/**
    ...
    <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
</svg>`;let It=class extends at{constructor(){super(...arguments),this.placeholder="",this.value="",this.options=[],this.isOpen=!1}connectedCallback(){this.onClickOutside=this.onClickOutside.bind(this)}shouldDisplayOptions(t){t?(this.optionsListElement.style.display="block",setTimeout(this.optionsListElement.focus.bind(this.optionsListElement),0)):this.optionsListElement.style.display="none",this.isOpen=t}onClickOutside(t){"undefined"!=typeof document&&t.target!==this&&(this.shouldDisplayOptions(!1),document.removeEventListener("click",this.onClickOutside))}onClickInside(t){"undefined"!=typeof document&&(this.isOpen?document.removeEventListener("click",this.onClickOutside):document.addEventListener("click",this.onClickOutside),this.shouldDisplayOptions(!this.isOpen))}renderOption(t,e){return q`<div class="option" @click="${()=>this.value=e}">${t}</div>`}render(){return q`
            <div id="container" @click="${this.onClickInside}">
                ...
                <div id="options-list">
                    ${Nt(this.options,(({label:t})=>t),(({label:t,value:e})=>this.renderOption(t,e)))}
                </div>
            </div>
        `}};It.styles=[ft,o`
            #container {
        ...
        `],Lt([pt({attribute:"placeholder"})],It.prototype,"placeholder",void 0),Lt([pt({attribute:"value"})],It.prototype,"value",void 0),Lt([pt({attribute:"options",type:Object})],It.prototype,"options",void 0),Lt([function(t){return pt({...t,state:!0,attribute:!1})}()],It.prototype,"isOpen",void 0),Lt([function(t,e){return(s,r,i)=>{const n=e=>e.renderRoot?.querySelector(t)??null;if(e){const{get:t,set:e}="object"==typeof r?s:i??(()=>{const t=Symbol();return{get(){return this[t]},set(e){this[t]=e}}})();return ut(s,r,{get(){let s=t.call(this);return void 0===s&&(s=n(this),(null!==s||this.hasUpdated)&&e.call(this,s)),s}})}return ut(s,r,{get(){return n(this)}})}}("#options-list")],It.prototype,"optionsListElement",void 0),It=Lt([ct("astra-select")],It);var Bt=It;t.AstraButton=yt,t.AstraCard=_t,t.AstraInput=St,t.AstraLabel=Ct,t.AstraSelect=Bt}({});
