...
.group:active .dark\\:group-active\\:bg-blue-800:is(.dark *) {
 ...
 `;var lr=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};class cr extends at{constructor(){super(...arguments),this.theme=Oe.light,this._class=this.theme}classMap(){return{dark:this.theme==Oe.dark}}willUpdate(t){super.willUpdate(t),this._class=nr(this.classMap())}render(){return V`<slot></slot>`}}cr.styles=[ar],lr([ut({attribute:"theme",type:String})],cr.prototype,"theme",void 0),lr([ut({reflect:!0,attribute:"class",type:String})],cr.prototype,"_class",void 0);var dr=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let hr=class extends cr{constructor(){super(),this.threshold=0,this.scroller=Gt(),this.rightScrollZone=Gt(),this.rightScrollHandle=Gt(),this.bottomScrollZone=Gt(),this.bottomScrollHandle=Gt(),this.hasHoveringCursor=!1,this.axis=Pe.both,this.isDragging=!1,this.verticalScrollPosition=0,this.horizontalScrollPosition=0,this.verticalScrollSize=0,this.horizontalScrollSize=0,this.horizontalScrollProgress=0,this.verticalScrollProgress=0,this.startX=0,this.startY=0,this.scrollStartX=0,this.scrollStartY=0,this._onScroll=this._onScroll?Me(this._onScroll,10).bind(this):this._onScroll.bind(this),this.updateScrollerSizeAndPosition=this.updateScrollerSizeAndPosition.bind(this),this.onWheelVerticalScroller=this.onWheelVerticalScroller.bind(this),this.onWheelHorizontalScroller=this.onWheelHorizontalScroller.bind(this),this.onHorizontalScrollerHandleMouseDown=this.onHorizontalScrollerHandleMouseDown.bind(this),this.onVerticalScrollerHandleMouseDown=this.onVerticalScrollerHandleMouseDown.bind(this)}updateScrollerSizeAndPosition(t){if([Pe.both,Pe.vertical].includes(this.axis)){const t=this.scroller.value?.scrollTop??0,e=this.scroller.value?.scrollHeight??0,r=(this.scroller.value?.clientHeight??0)/e;this.verticalScrollSize=1===r?0:(this.scroller.value?.clientHeight??0)*r,this.verticalScrollProgress=t/e,this.verticalScrollPosition=this.verticalScrollProgress*(this.scroller.value?.clientHeight??0)}if([Pe.both,Pe.horizontal].includes(this.axis)){const t=this.scroller.value?.scrollWidth??0,e=this.scroller.value?.scrollLeft??0,r=(this.scroller.value?.clientWidth??0)/t,o=1===r?0:(this.scroller.value?.clientWidth??0)*r;this.horizontalScrollProgress=e/t,this.horizontalScrollSize=o,this.horizontalScrollPosition=this.horizontalScrollProgress*(this.scroller.value?.clientWidth??0)}}_onScroll(t){const e=this.previousScrollPosition??0,r=this.scroller.value?.scrollTop??0;Math.abs(e-r)>this.threshold&&(this.previousScrollPosition=r,"function"==typeof this.onScroll&&this.onScroll())}onClickVerticalScroller(t){if(this.scroller.value){const e=(t.clientY-this.getBoundingClientRect().top)/this.scroller.value?.clientHeight;this.scroller.value.scrollTop=e*(this.scroller.value?.scrollHeight??0)-this.verticalScrollSize}}onClickHorizontalScroller(t){if(this.scroller.value){const e=(t.clientX-this.getBoundingClientRect().left)/this.scroller.value?.clientWidth;this.scroller.value.scrollLeft=e*(this.scroller.value?.scrollWidth??0)-this.horizontalScrollSize}}onWheelHorizontalScroller(t){this.scroller.value&&(this.scroller.value.scrollLeft+=t.deltaX)}onWheelVerticalScroller(t){this.scroller.value&&(this.scroller.value.scrollTop+=t.deltaY)}onHorizontalScrollerHandleMouseDown(t){t.preventDefault(),this.startX=t.pageX,this.scrollStartX=this.scroller.value?.scrollLeft??0;const e=t=>{const e=t.pageX-this.startX,r=this.scroller.value?.scrollWidth??0,o=(this.scroller.value?.clientWidth??0)/r;this.scroller.value&&(this.scroller.value.scrollLeft=this.scrollStartX+e/o)},r=t=>{document.removeEventListener("mousemove",e),document.removeEventListener("mouseup",r)};document.addEventListener("mouseup",r),document.addEventListener("mousemove",e)}preventDefault(t){t.preventDefault()}onVerticalScrollerHandleMouseDown(t){t.preventDefault(),this.startY=t.pageY,this.scrollStartY=this.scroller.value?.scrollTop??0;const e=t=>{t.preventDefault();const e=t.pageY-this.startY,r=this.scroller.value?.scrollHeight??0,o=(this.scroller.value?.clientHeight??0)/r;this.scroller.value&&(this.scroller.value.scrollTop=this.scrollStartY+e/o)},r=t=>{document.removeEventListener("mousemove",e),document.removeEventListener("mouseup",r)};document.addEventListener("mouseup",r),document.addEventListener("mousemove",e)}connectedCallback(){super.connectedCallback(),setTimeout((()=>{this.scroller.value?.addEventListener("scroll",this.updateScrollerSizeAndPosition,{passive:!0}),this.scroller.value?.addEventListener("scroll",this._onScroll,{passive:!0}),this.scroller.value?.addEventListener("scrollend",this._onScroll,{passive:!0}),this.rightScrollZone.value?.addEventListener("wheel",this.onWheelVerticalScroller,{passive:!0}),this.bottomScrollZone.value?.addEventListener("wheel",this.onWheelHorizontalScroller,{passive:!0}),this.bottomScrollHandle.value?.addEventListener("mousedown",this.onHorizontalScrollerHandleMouseDown),this.rightScrollHandle.value?.addEventListener("mousedown",this.onVerticalScrollerHandleMouseDown),this.rightScrollZone.value?.addEventListener("contextmenu",this.preventDefault),this.bottomScrollZone.value?.addEventListener("contextmenu",this.preventDefault),this.bottomScrollHandle.value?.addEventListener("contextmenu",this.preventDefault),this.rightScrollHandle.value?.addEventListener("contextmenu",this.preventDefault)}),0)}disconnectedCallback(){super.disconnectedCallback(),this.scroller.value?.removeEventListener("scroll",this.updateScrollerSizeAndPosition),this.scroller.value?.removeEventListener("scroll",this._onScroll),this.scroller.value?.removeEventListener("scrollend",this._onScroll),this.rightScrollZone.value?.removeEventListener("wheel",this.onWheelVerticalScroller),this.bottomScrollZone.value?.removeEventListener("wheel",this.onWheelHorizontalScroller),this.bottomScrollHandle.value?.removeEventListener("mousedown",this.onHorizontalScrollerHandleMouseDown),this.rightScrollHandle.value?.removeEventListener("mousedown",this.onVerticalScrollerHandleMouseDown),this.rightScrollZone.value?.removeEventListener("contextmenu",this.preventDefault),this.bottomScrollZone.value?.removeEventListener("contextmenu",this.preventDefault),this.bottomScrollHandle.value?.removeEventListener("contextmenu",this.preventDefault),this.rightScrollHandle.value?.removeEventListener("contextmenu",this.preventDefault)}willUpdate(t){super.willUpdate(t),t.has("theme")&&this.requestUpdate("class"),t.has("hasHoveringCursor")&&this.hasHoveringCursor&&this.updateScrollerSizeAndPosition()}render(){const t={"w-full rounded-md":!0,"bg-neutral-200/60 dark:bg-neutral-700/50":!0,"hover:bg-neutral-300 dark:hover:bg-neutral-700":!0,"active:bg-neutral-300 dark:active:bg-neutral-700":!0},e={"z-50 absolute right-0 bottom-0 m-0.5":!0,"transition-opacity duration-300":!0,"opacity-0":!this.hasHoveringCursor,"opacity-100":this.hasHoveringCursor},r={transform:`translateY(${this.verticalScrollPosition}px)`,height:`${this.verticalScrollSize}px`},o={transform:`translateX(${this.horizontalScrollPosition}px)`,width:`${this.horizontalScrollSize}px`},i={"absolute bottom-0 left-0 right-0 top-0":!0,"overflow-scroll":this.axis===Pe.both,"overflow-x-scroll overflow-y-hidden":this.axis===Pe.horizontal,"overflow-y-scroll overflow-x-hidden":this.axis===Pe.vertical};return V`<!-- this comment exists to force the next line onto the next line -->
            <div
                ...
                class=${Mt({dark:this.theme==Oe.dark})}
            >
                <div
...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const pr=(t,e,r)=>{const o=new Map;for(let i=e;i<=r;i++)o.set(t[i],i);return o},gr=jt(class extends It{constructor(t){if(super(t),t.type!==zt)throw Error("repeat() can only be used in text expressions")}dt(t,e,r){let o;void 0===r?r=e:void 0!==e&&(o=e);const i=[],s=[];let n=0;for(const e of t)i[n]=o?o(e,n):n,s[n]=r(e,n),n++;return{values:s,keys:i}}render(t,e,r){return this.dt(t,e,r).values}update(t,[e,r,o]){const i=(t=>t._$AH)(t),{values:s,keys:n}=this.dt(e,r,o);if(!Array.isArray(i))return this.ut=n,s;const a=this.ut??=[],l=[];let c,d,h=0,u=i.length-1,p=0,g=s.length-1;for(;h<=u&&p<=g;)if(null===i[h])h++;else if(null===i[u])u--;else if(a[h]===n[p])l[p]=Ht(i[h],s[p]),h++,p++;else if(a[u]===n[g])l[g]=Ht(i[u],s[g]),u--,g--;else if(a[h]===n[g])l[g]=Ht(i[h],s[g]),Nt(t,l[g+1],i[h]),h++,g--;else if(a[u]===n[p])l[p]=Ht(i[u],s[p]),Nt(t,i[h],i[u]),u--,p++;else if(void 0===c&&(c=pr(n,p,g),d=pr(a,h,u)),c.has(a[h]))if(c.has(a[u])){const e=d.get(n[p]),r=void 0!==e?i[e]:null;if(null===r){const e=Nt(t,i[h]);Ht(e,s[p]),l[p]=e}else l[p]=Ht(r,s[p]),Nt(t,i[h],r),i[e]=null;p++}else Vt(i[u]),u--;else Vt(i[h]),h++;for(;p<=g;){const e=Nt(t,l[g+1]);Ht(e,s[p]),l[p++]=e}for(;h<=u;){const t=i[h++];null!==t&&Vt(t)}return this.ut=n,((t,e=Bt)=>{t._$AH=e})(t,l),W}});var br=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};const vr=V`<svg
    aria-hidden="true"
...
>
    <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
        ...
        >
            ...
            <div id="container" aria-haspopup="listbox" tabindex="0" @click=${this.onClickInside} role="listbox">
                ...
                <ul id="options-list" aria-owns="container" role="menu">
                    ${gr(this.options,(({label:t})=>t),(({label:t,value:e})=>this.renderOption(t,e)))}
                </ul>
            </div>
        `}};fr.styles=[ar,mt,n`
            #container {
        ...
        `],br([ut({attribute:"aria-expanded",reflect:!0})],fr.prototype,"ariaExpanded",void 0),br([ut({attribute:"placeholder"})],fr.prototype,"placeholder",void 0),br([ut({attribute:"value"})],fr.prototype,"value",void 0),br([ut({attribute:"options",type:Array})],fr.prototype,"options",void 0),br([ut({attribute:"disabled",type:Boolean})],fr.prototype,"disabled",void 0),br([pt()],fr.prototype,"isOpen",void 0),br([function(t,e){return(r,o,i)=>{const s=e=>e.renderRoot?.querySelector(t)??null;if(e){const{get:t,set:e}="object"==typeof o?r:i??(()=>{const t=Symbol();return{get(){return this[t]},set(e){this[t]=e}}})();return gt(r,o,{get(){let r=t.call(this);return void 0===r&&(r=s(this),(null!==r||this.hasUpdated)&&e.call(this,r)),r}})}return gt(r,o,{get(){return s(this)}})}}("#options-list")],fr.prototype,"optionsListElement",void 0),fr=br([ct("astra-select")],fr);var mr=fr;
/**
     * @license
     * Copyright 2018 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const wr=t=>t??F;var yr,kr=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let xr=yr=class extends at{constructor(){super(...arguments),this.checked=!1,this.theme=Oe.light,this.tabIndex=0,this._class="focus:shadow-ringlet dark:focus:shadow-ringlet-dark focus:rounded-md focus:ring-1 focus:ring-black dark:focus:ring-neutral-300 focus:outline-none"}toggleCheckbox(t){t.preventDefault(),this.checked=!this.checked,this.dispatchEvent(new sr)}onKeyDown(t){const{code:e}=t;"Enter"!==e&&"Space"!==e||this.toggleCheckbox(t)}connectedCallback(){super.connectedCallback(),this.addEventListener("keydown",this.onKeyDown)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("keydown",this.onKeyDown)}render(){const t=Mt({"flex items-center cursor-pointer":!0,dark:this.theme==Oe.dark});return V`
    ...
    >`,xr.uncheckedTemplate=V`<span class="w-4 h-4 border border-neutral-500 rounded-md"></span>`,kr([ut({type:Boolean})],xr.prototype,"checked",void 0),kr([ut({type:String})],xr.prototype,"theme",void 0),kr([ut({attribute:"class",type:String,reflect:!0})],xr.prototype,"_class",void 0),xr=yr=kr([ct("check-box")],xr);const _r=t=>V`<svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${t}" fill="currentColor" viewBox="0 0 256 256">
        <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
            ...
            ${gr(this.activeOptions,(({label:t})=>t),(({label:t,value:e,classes:r})=>V`<li
        ...
        </ul>`}onTrigger(t){this.open=!this.open,this.activeEvent=t}onItemClick(t){let e=t.target;for(;e&&!e.hasAttribute("data-value")&&e.parentElement;)e=e.parentElement;const r=e.getAttribute("data-value");if(!r)throw new Error("onItemClick didn't recover a selection value");this.onSelection(t,r)}onSelection(t,e){const r=this.options.find((t=>t.value===e));if(r&&r.options)return t.stopPropagation(),t.preventDefault(),this.historyStack.push(this.options),void(this.options=r.options);if("string"==typeof e){const t=new Qe(e);this.selection=e,this.dispatchEvent(t)}}onKeyDown(t){const{code:e}=t;if("Escape"===e)this.open=!1;else if("Space"===e||"Enter"===e)t.preventDefault(),this.open=!this.open,t.didCloseMenu=!0,!this.open&&this.focused&&this.onSelection(t,this.focused);else if("ArrowDown"===e||"ArrowRight"===e)if(t.preventDefault(),this.focused){const t=this.activeOptions.findIndex((({value:t},e)=>t===this.focused));t>-1&&t<this.activeOptions.length-1?this.focused=this.activeOptions[t+1].value:t===this.activeOptions.length-1&&(this.focused=this.activeOptions[0].value)}else this.focused=this.activeOptions[0]?.value;else if("ArrowUp"===e||"ArrowLeft"===e)if(t.preventDefault(),this.focused){const t=this.activeOptions.findIndex((({value:t},e)=>t===this.focused));t>0?this.focused=this.activeOptions[t-1].value:0===t&&(this.focused=this.activeOptions[this.activeOptions.length-1].value)}else this.focused=this.activeOptions[this.activeOptions.length-1]?.value;else"Tab"===e&&this.open&&t.preventDefault()}focus(){const t=this.shadowRoot?.querySelector("#trigger");t?.focus()}willUpdate(t){super.willUpdate(t),t.has("open")&&this.open?(this.setAttribute("aria-expanded",""),this.outsideClicker=(t=>{t!==this.activeEvent&&(this.open=!1,delete this.activeEvent,this.outsideClicker&&document.removeEventListener("click",this.outsideClicker))}).bind(this),document.addEventListener("click",this.outsideClicker),this.dispatchEvent(new ir(this.close))):t.has("open")&&!this.open&&(this.removeAttribute("aria-expanded"),this.historyStack.length>0&&(this.options=this.historyStack[0],this.historyStack=[]),this.outsideClicker&&(delete this.activeEvent,document.removeEventListener("click",this.outsideClicker))),t.has("options")&&(this.activeOptions=this.options)}updated(t){super.updated(t),t.has("open")&&!this.open&&(this.focused=void 0)}render(){const t={"relative -mr-1 cursor-pointer":!0,dark:this.theme==Oe.dark};return V`
            <slot></slot>
            <div
                id="trigger"
                class=${Mt(t)}
        ...
        `}}Er([ut({type:Boolean,attribute:"open",reflect:!0})],Sr.prototype,"open",void 0),Er([ut({attribute:"selection",type:String})],Sr.prototype,"selection",void 0),Er([ut({type:Array,attribute:"options"})],Sr.prototype,"options",void 0),Er([ut({attribute:"without-padding",type:Boolean})],Sr.prototype,"withoutPadding",void 0),Er([pt()],Sr.prototype,"activeOptions",void 0),Er([pt()],Sr.prototype,"historyStack",void 0),Er([pt()],Sr.prototype,"focused",void 0);var Cr=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let Ar=class extends Sr{constructor(){super(...arguments),this._classMap={"focus:ring-1 focus:ring-neutral-950 dark:focus:ring-neutral-50 focus:outline-none ":!0,"px-2 py-1.5":!0,"bg-neutral-50 dark:bg-neutral-950 text-neutral-950 dark:text-neutral-50":!0,"placeholder-neutral-400 dark:placeholder-neutral-600":!0,"rounded-md border border-neutral-400 dark:border-neutral-600":!0},this.value=""}get menuPositionClasses(){return"left-0 right-0 top-8"}onMenuSelection(t){const{value:e}=t;this.value=e}onKeyDown(t){if(this.open)return super.onKeyDown({...t,didCloseMenu:!1});const{code:e}=t;"Space"!==e&&"ArrowLeft"!==e&&"ArrowRight"!==e&&("ArrowDown"===e?this.open=!0:super.onKeyDown({...t,didCloseMenu:!1}))}connectedCallback(){super.connectedCallback(),this.addEventListener("menu-selection",this.onMenuSelection)}disconnectedCallback(){super.disconnectedCallback(),this.removeEventListener("menu-selection",this.onMenuSelection)}willUpdate(t){super.willUpdate(t),t.has("value")&&this.dispatchEvent&&this.dispatchEvent(new or(this.value))}render(){return V`
            ...
            @input=${t=>{const{value:e}=t.target;this.value=e}}
                class=${Mt({"relative w-full":!0,dark:this.theme==Oe.dark,...this._classMap})}
                tabindex="0"
                type="text"
                autocomplete="off"
                required
        ...
        `}};Cr([ut({type:Object})],Ar.prototype,"_classMap",void 0),Cr([ut({type:String})],Ar.prototype,"value",void 0),Ar=Cr([ct("astra-input-menu")],Ar);var Rr,Or=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let Pr=Rr=class extends cr{constructor(){super(...arguments),this.columnName="",this.columnType=""}classMap(){return{"inline-block p-3.5 w-40":!0,"text-xs":!0,"bg-neutral-50 dark:bg-neutral-950 text-neutral-950 dark:text-neutral-50":!0,"rounded-lg border border-neutral-400 dark:border-neutral-600":!0,...super.classMap()}}onChange(t){const{value:e}=t.target;this.columnName=e}onSubmit(t){if(t.preventDefault(),!this.columnName)throw new Error("Missing column name");this.dispatchEvent(new Be({name:this.columnName,data:{type:this.columnType}}))}render(){return V`<form @submit=${this.onSubmit} class="flex flex-col gap-3.5 text-xs">
        ...
        </form>`}};Pr.labelClasses={"font-medium":!0},Pr.inputClasses={"focus:ring-1 focus:ring-neutral-500 focus:outline-none ":!0,"px-2 py-1.5":!0,"bg-neutral-50 dark:bg-neutral-950 text-neutral-950 dark:text-neutral-50":!0,"placeholder-neutral-600 dark:placeholder-neutral-400":!0,"rounded-md border border-neutral-400 dark:border-neutral-600 focus:dark:border-neutral-300":!0},Pr.buttonClasses={"bg-neutral-950 dark:bg-neutral-50 hover:bg-neutral-800 hover:dark:bg-neutral-200":!0,"text-neutral-50 dark:text-neutral-950":!0,"px-5 py-1.5 rounded-md":!0,"disabled:bg-neutral-400 disabled:dark:bg-neutral-600":!0},Or([pt()],Pr.prototype,"columnName",void 0),Or([pt()],Pr.prototype,"columnType",void 0),Or([pt()],Pr.prototype,"errorMessage",void 0),Pr=Rr=Or([ct("astra-add-column")],Pr);let Dr=class extends cr{classMap(){return{"p-0.5 rounded-md cursor-pointer":!0,"dark:bg-neutral-950 hover:bg-neutral-100 dark:hover:bg-neutral-900":!0,"border border-transparent active:border-neutral-200 dark:active:border-neutral-800":!0,...super.classMap()}}render(){return V`${(t=>V` <svg xmlns="http://www.w3.org/2000/svg" width="${t}" height="${t}" viewBox="0 0 256 256">
        <rect width="256" height="256" fill="none" />
        <line
            x1="40"
            y1="128"
...
class jr extends It{constructor(t){if(super(t),this.it=F,t.type!==zt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===F||null==t)return this._t=void 0,this.it=t;if(t===W)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}jr.directiveName="unsafeHTML",jr.resultType=1;const Ir=jt(jr);function Mr(t){return t.composedPath().some((t=>{if(t instanceof HTMLElement&&t.tagName.toLowerCase().includes("astra-plugin"))return!0}))}var Lr=Array.isArray,Ur="[object AsyncFunction]",Nr="[object Function]",Hr="[object GeneratorFunction]",Br="[object Proxy]";function Vr(t){if(!ie(t))return!1;var e=ke(t);return e==Nr||e==Hr||e==Ur||e==Br}var Wr,Fr=ae["__core-js_shared__"],qr=(Wr=/[^.]+$/.exec(Fr&&Fr.keys&&Fr.keys.IE_PROTO||""))?"Symbol(src)_1."+Wr:"";var Kr=Function.prototype.toString;function Yr(t){if(null!=t){try{return Kr.call(t)}catch(t){}try{return t+""}catch(t){}}return""}var Zr=/^\[object .+?Constructor\]$/,Xr=Function.prototype,Gr=Object.prototype,Jr=Xr.toString,Qr=Gr.hasOwnProperty,to=RegExp("^"+Jr.call(Qr).replace(/[\\^$.*+?()[\]{}|]/g,"\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g,"$1.*?")+"$");function eo(t){return!(!ie(t)||(e=t,qr&&qr in e))&&(Vr(t)?to:Zr).test(Yr(t));var e}function ro(t,e){var r=function(t,e){return null==t?void 0:t[e]}(t,e);return eo(r)?r:void 0}var oo=ro(ae,"WeakMap"),io=9007199254740991,so=/^(?:0|[1-9]\d*)$/;function no(t,e){var r=typeof t;return!!(e=null==e?io:e)&&("number"==r||"symbol"!=r&&so.test(t))&&t>-1&&t%1==0&&t<e}function ao(t,e){return t===e||t!=t&&e!=e}var lo=9007199254740991;function co(t){return"number"==typeof t&&t>-1&&t%1==0&&t<=lo}var ho=Object.prototype;function uo(t){return xe(t)&&"[object Arguments]"==ke(t)}var po=Object.prototype,go=po.hasOwnProperty,bo=po.propertyIsEnumerable,vo=uo(function(){return arguments}())?uo:function(t){return xe(t)&&go.call(t,"callee")&&!bo.call(t,"callee")};var fo="object"==typeof t&&t&&!t.nodeType&&t,mo=fo&&"object"==typeof module&&module&&!module.nodeType&&module,wo=mo&&mo.exports===fo?ae.Buffer:void 0,yo=(wo?wo.isBuffer:void 0)||function(){return!1},ko={};ko["[object Float32Array]"]=ko["[object Float64Array]"]=ko["[object Int8Array]"]=ko["[object Int16Array]"]=ko["[object Int32Array]"]=ko["[object Uint8Array]"]=ko["[object Uint8ClampedArray]"]=ko["[object Uint16Array]"]=ko["[object Uint32Array]"]=!0,ko["[object Arguments]"]=ko["[object Array]"]=ko["[object ArrayBuffer]"]=ko["[object Boolean]"]=ko["[object DataView]"]=ko["[object Date]"]=ko["[object Error]"]=ko["[object Function]"]=ko["[object Map]"]=ko["[object Number]"]=ko["[object Object]"]=ko["[object RegExp]"]=ko["[object Set]"]=ko["[object String]"]=ko["[object WeakMap]"]=!1;var xo,$o="object"==typeof t&&t&&!t.nodeType&&t,_o=$o&&"object"==typeof module&&module&&!module.nodeType&&module,Eo=_o&&_o.exports===$o&&se.process,So=function(){try{var t=_o&&_o.require&&_o.require("util").types;return t||Eo&&Eo.binding&&Eo.binding("util")}catch(t){}}(),Co=So&&So.isTypedArray,Ao=Co?(xo=Co,function(t){return xo(t)}):function(t){return xe(t)&&co(t.length)&&!!ko[ke(t)]},Ro=Object.prototype.hasOwnProperty;function Oo(t,e){var r=Lr(t),o=!r&&vo(t),i=!r&&!o&&yo(t),s=!r&&!o&&!i&&Ao(t),n=r||o||i||s,a=n?function(t,e){for(var r=-1,o=Array(t);++r<t;)o[r]=e(r);return o}(t.length,String):[],l=a.length;for(var c in t)!e&&!Ro.call(t,c)||n&&("length"==c||i&&("offset"==c||"parent"==c)||s&&("buffer"==c||"byteLength"==c||"byteOffset"==c)||no(c,l))||a.push(c);return a}var Po=function(t,e){return function(r){return t(e(r))}}(Object.keys,Object),Do=Object.prototype.hasOwnProperty;function To(t){if(r=(e=t)&&e.constructor,e!==("function"==typeof r&&r.prototype||ho))return Po(t);var e,r,o=[];for(var i in Object(t))Do.call(t,i)&&"constructor"!=i&&o.push(i);return o}function zo(t){return null!=(e=t)&&co(e.length)&&!Vr(e)?Oo(t):To(t);var e}var jo=ro(Object,"create");var Io=Object.prototype.hasOwnProperty;var Mo=Object.prototype.hasOwnProperty;function Lo(t){var e=-1,r=null==t?0:t.length;for(this.clear();++e<r;){var o=t[e];this.set(o[0],o[1])}}function Uo(t,e){for(var r=t.length;r--;)if(ao(t[r][0],e))return r;return-1}Lo.prototype.clear=function(){this.__data__=jo?jo(null):{},this.size=0},Lo.prototype.delete=function(t){var e=this.has(t)&&delete this.__data__[t];return this.size-=e?1:0,e},Lo.prototype.get=function(t){var e=this.__data__;if(jo){var r=e[t];return"__lodash_hash_undefined__"===r?void 0:r}return Io.call(e,t)?e[t]:void 0},Lo.prototype.has=function(t){var e=this.__data__;return jo?void 0!==e[t]:Mo.call(e,t)},Lo.prototype.set=function(t,e){var r=this.__data__;return this.size+=this.has(t)?0:1,r[t]=jo&&void 0===e?"__lodash_hash_undefined__":e,this};var No=Array.prototype.splice;function Ho(t){var e=-1,r=null==t?0:t.length;for(this.clear();++e<r;){var o=t[e];this.set(o[0],o[1])}}Ho.prototype.clear=function(){this.__data__=[],this.size=0},Ho.prototype.delete=function(t){var e=this.__data__,r=Uo(e,t);return!(r<0)&&(r==e.length-1?e.pop():No.call(e,r,1),--this.size,!0)},Ho.prototype.get=function(t){var e=this.__data__,r=Uo(e,t);return r<0?void 0:e[r][1]},Ho.prototype.has=function(t){return Uo(this.__data__,t)>-1},Ho.prototype.set=function(t,e){var r=this.__data__,o=Uo(r,t);return o<0?(++this.size,r.push([t,e])):r[o][1]=e,this};var Bo=ro(ae,"Map");function Vo(t,e){var r,o,i=t.__data__;return("string"==(o=typeof(r=e))||"number"==o||"symbol"==o||"boolean"==o?"__proto__"!==r:null===r)?i["string"==typeof e?"string":"hash"]:i.map}function Wo(t){var e=-1,r=null==t?0:t.length;for(this.clear();++e<r;){var o=t[e];this.set(o[0],o[1])}}Wo.prototype.clear=function(){this.size=0,this.__data__={hash:new Lo,map:new(Bo||Ho),string:new Lo}},Wo.prototype.delete=function(t){var e=Vo(this,t).delete(t);return this.size-=e?1:0,e},Wo.prototype.get=function(t){return Vo(this,t).get(t)},Wo.prototype.has=function(t){return Vo(this,t).has(t)},Wo.prototype.set=function(t,e){var r=Vo(this,t),o=r.size;return r.set(t,e),this.size+=r.size==o?0:1,this};function Fo(t){var e=this.__data__=new Ho(t);this.size=e.size}Fo.prototype.clear=function(){this.__data__=new Ho,this.size=0},Fo.prototype.delete=function(t){var e=this.__data__,r=e.delete(t);return this.size=e.size,r},Fo.prototype.get=function(t){return this.__data__.get(t)},Fo.prototype.has=function(t){return this.__data__.has(t)},Fo.prototype.set=function(t,e){var r=this.__data__;if(r instanceof Ho){var o=r.__data__;if(!Bo||o.length<199)return o.push([t,e]),this.size=++r.size,this;r=this.__data__=new Wo(o)}return r.set(t,e),this.size=r.size,this};var qo=Object.prototype.propertyIsEnumerable,Ko=Object.getOwnPropertySymbols,Yo=Ko?function(t){return null==t?[]:(t=Object(t),function(t,e){for(var r=-1,o=null==t?0:t.length,i=0,s=[];++r<o;){var n=t[r];e(n,r,t)&&(s[i++]=n)}return s}(Ko(t),(function(e){return qo.call(t,e)})))}:function(){return[]};function Zo(t){return function(t,e,r){var o=e(t);return Lr(t)?o:function(t,e){for(var r=-1,o=e.length,i=t.length;++r<o;)t[i+r]=e[r];return t}(o,r(t))}(t,zo,Yo)}var Xo=ro(ae,"DataView"),Go=ro(ae,"Promise"),Jo=ro(ae,"Set"),Qo="[object Map]",ti="[object Promise]",ei="[object Set]",ri="[object WeakMap]",oi="[object DataView]",ii=Yr(Xo),si=Yr(Bo),ni=Yr(Go),ai=Yr(Jo),li=Yr(oo),ci=ke;(Xo&&ci(new Xo(new ArrayBuffer(1)))!=oi||Bo&&ci(new Bo)!=Qo||Go&&ci(Go.resolve())!=ti||Jo&&ci(new Jo)!=ei||oo&&ci(new oo)!=ri)&&(ci=function(t){var e=ke(t),r="[object Object]"==e?t.constructor:void 0,o=r?Yr(r):"";if(o)switch(o){case ii:return oi;case si:return Qo;case ni:return ti;case ai:return ei;case li:return ri}return e});var di=ci,hi=ae.Uint8Array;function ui(t){var e=-1,r=null==t?0:t.length;for(this.__data__=new Wo;++e<r;)this.add(t[e])}function pi(t,e){for(var r=-1,o=null==t?0:t.length;++r<o;)if(e(t[r],r,t))return!0;return!1}ui.prototype.add=ui.prototype.push=function(t){return this.__data__.set(t,"__lodash_hash_undefined__"),this},ui.prototype.has=function(t){return this.__data__.has(t)};var gi=1,bi=2;function vi(t,e,r,o,i,s){var n=r&gi,a=t.length,l=e.length;if(a!=l&&!(n&&l>a))return!1;var c=s.get(t),d=s.get(e);if(c&&d)return c==e&&d==t;var h=-1,u=!0,p=r&bi?new ui:void 0;for(s.set(t,e),s.set(e,t);++h<a;){var g=t[h],b=e[h];if(o)var v=n?o(b,g,h,e,t,s):o(g,b,h,t,e,s);if(void 0!==v){if(v)continue;u=!1;break}if(p){if(!pi(e,(function(t,e){if(n=e,!p.has(n)&&(g===t||i(g,t,r,o,s)))return p.push(e);var n}))){u=!1;break}}else if(g!==b&&!i(g,b,r,o,s)){u=!1;break}}return s.delete(t),s.delete(e),u}function fi(t){var e=-1,r=Array(t.size);return t.forEach((function(t,o){r[++e]=[o,t]})),r}function mi(t){var e=-1,r=Array(t.size);return t.forEach((function(t){r[++e]=t})),r}var wi=1,yi=2,ki="[object Boolean]",xi="[object Date]",$i="[object Error]",_i="[object Map]",Ei="[object Number]",Si="[object RegExp]",Ci="[object Set]",Ai="[object String]",Ri="[object Symbol]",Oi="[object ArrayBuffer]",Pi="[object DataView]",Di=ue?ue.prototype:void 0,Ti=Di?Di.valueOf:void 0;var zi=1,ji=Object.prototype.hasOwnProperty;var Ii=1,Mi="[object Arguments]",Li="[object Array]",Ui="[object Object]",Ni=Object.prototype.hasOwnProperty;function Hi(t,e,r,o,i,s){var n=Lr(t),a=Lr(e),l=n?Li:di(t),c=a?Li:di(e),d=(l=l==Mi?Ui:l)==Ui,h=(c=c==Mi?Ui:c)==Ui,u=l==c;if(u&&yo(t)){if(!yo(e))return!1;n=!0,d=!1}if(u&&!d)return s||(s=new Fo),n||Ao(t)?vi(t,e,r,o,i,s):function(t,e,r,o,i,s,n){switch(r){case Pi:if(t.byteLength!=e.byteLength||t.byteOffset!=e.byteOffset)return!1;t=t.buffer,e=e.buffer;case Oi:return!(t.byteLength!=e.byteLength||!s(new hi(t),new hi(e)));case ki:case xi:case Ei:return ao(+t,+e);case $i:return t.name==e.name&&t.message==e.message;case Si:case Ai:return t==e+"";case _i:var a=fi;case Ci:var l=o&wi;if(a||(a=mi),t.size!=e.size&&!l)return!1;var c=n.get(t);if(c)return c==e;o|=yi,n.set(t,e);var d=vi(a(t),a(e),o,i,s,n);return n.delete(t),d;case Ri:if(Ti)return Ti.call(t)==Ti.call(e)}return!1}(t,e,l,r,o,i,s);if(!(r&Ii)){var p=d&&Ni.call(t,"__wrapped__"),g=h&&Ni.call(e,"__wrapped__");if(p||g){var b=p?t.value():t,v=g?e.value():e;return s||(s=new Fo),i(b,v,r,o,s)}}return!!u&&(s||(s=new Fo),function(t,e,r,o,i,s){var n=r&zi,a=Zo(t),l=a.length;if(l!=Zo(e).length&&!n)return!1;for(var c=l;c--;){var d=a[c];if(!(n?d in e:ji.call(e,d)))return!1}var h=s.get(t),u=s.get(e);if(h&&u)return h==e&&u==t;var p=!0;s.set(t,e),s.set(e,t);for(var g=n;++c<l;){var b=t[d=a[c]],v=e[d];if(o)var f=n?o(v,b,d,e,t,s):o(b,v,d,t,e,s);if(!(void 0===f?b===v||i(b,v,r,o,s):f)){p=!1;break}g||(g="constructor"==d)}if(p&&!g){var m=t.constructor,w=e.constructor;m==w||!("constructor"in t)||!("constructor"in e)||"function"==typeof m&&m instanceof m&&"function"==typeof w&&w instanceof w||(p=!1)}return s.delete(t),s.delete(e),p}(t,e,r,o,i,s))}function Bi(t,e,r,o,i){return t===e||(null==t||null==e||!xe(t)&&!xe(e)?t!=t&&e!=e:Hi(t,e,r,o,Bi,i))}var Vi=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};const Wi=["Int","Integer","SmallInt","BigInt","Decimal","Float","Real","Double Precision","TinyInt","MediumInt","Serial","BigSerial"].map((t=>t.toLowerCase())),Fi=["Boolean","Bit"].map((t=>t.toLowerCase())),qi=["JSON","JSONB","ARRAY"].map((t=>t.toLowerCase()));class Ki extends cr{constructor(){super(...arguments),this._didSetInitialValue=!1,this.constrainTypes=!1,this.position={column:"",row:""},this.readonly=!1,this.isInteractive=!1,this.outerBorder=!1,this.separateCells=!1,this.blank=!1,this.isEditing=!1,this.hasMenu=!1,this.isFirstColumn=!1,this.isLastColumn=!1}static moveFocusToNextRow(t){const e=t?.parentElement,r=Array.from(e?.children??[]).indexOf(t),o=e?e.nextElementSibling:null;if(o&&o.children.length>r){var i=o.children[r];i&&i.focus()}}static moveFocusToPreviousRow(t){const e=t?.parentElement,r=Array.from(e?.children??[]).indexOf(t),o=e?e.previousElementSibling:null;if(o&&o.children.length>r){var i=o.children[r];i&&i.focus()}}static onKeyDown(t){const e=t.currentTarget;if("Escape"===t.code&&(t.stopPropagation(),t.preventDefault(),e.isEditing=!1,e.focus()),"Enter"===t.code&&e.isEditing&&t.target instanceof HTMLElement){const r=t.target;setTimeout((()=>{e.isEditing=!1,e.focus(),setTimeout((()=>{Ki.moveFocusToNextRow(r)}),0)}))}"Enter"===t.code&&!e.isEditing&&e.readonly&&t.preventDefault(),"Enter"!==t.code||e.isEditing||e.readonly||t.target instanceof HTMLElement&&!e.isEditing&&(t.didCloseMenu||(e.isEditing=!0))}static convertToType(t,e){if(t&&"string"==typeof e){if(Wi.includes(t))return parseInt(e,10);if(qi.includes(t))return JSON.parse(e);if(Fi.includes(t))return"true"===e.toLowerCase().trim();if(""===e)return null}return e}classMap(){return{"cursor-pointer":this.isInteractive&&!this.readonly,...super.classMap()}}get value(){return this._value}set value(t){const e=this._value;e!==t&&(this.constrainTypes?this._value=Ki.convertToType(this.type,t)??t:this._value=t,this.requestUpdate("value",e),this._didSetInitialValue&&this.dispatchChangedEvent(),this._didSetInitialValue=!0)}get originalValue(){return this._originalValue}set originalValue(t){const e=this._originalValue;this.constrainTypes?this._originalValue=Ki.convertToType(this.type,t)??t:this._originalValue=t,this.requestUpdate("originalValue",e)}get dirty(){return t=this.value,e=this.originalValue,!Bi(t,e);var t,e}get type(){return this._type}set type(t){this._type=t?.toLowerCase()}updated(t){if(super.updated(t),t.has("isEditing")&&this.isEditing){const t=this.shadowRoot?.querySelector("input");t&&t.select()}}willUpdate(t){super.willUpdate(t),this.constrainTypes&&t.has("type")&&(this.value=Ki.convertToType(this.type,this.value)??this._value,this.originalValue=Ki.convertToType(this.type,this.originalValue)??this.originalValue)}dispatchChangedEvent(){const t={position:this.position,previousValue:this.originalValue,value:this.value,label:this.label};this.dispatchEvent(new Ue(t))}onBlur(){this.isEditing=!1}onChange(t){const{value:e}=t.target;this.value=""===e?null:e}}Vi([ut({attribute:"constrain-types",type:Boolean})],Ki.prototype,"constrainTypes",void 0),Vi([ut({attribute:"value",type:String})],Ki.prototype,"value",null),Vi([ut({attribute:"original-value",type:String})],Ki.prototype,"originalValue",null),Vi([ut({type:String})],Ki.prototype,"dirty",null),Vi([ut({type:Object,attribute:"position"})],Ki.prototype,"position",void 0),Vi([ut({type:String})],Ki.prototype,"label",void 0),Vi([ut({attribute:"read-only",type:Boolean})],Ki.prototype,"readonly",void 0),Vi([ut({type:String,attribute:"width"})],Ki.prototype,"width",void 0),Vi([ut({attribute:"interactive",type:Boolean})],Ki.prototype,"isInteractive",void 0),Vi([ut({attribute:"outer-border",type:Boolean})],Ki.prototype,"outerBorder",void 0),Vi([ut({type:Boolean,attribute:"separate-cells"})],Ki.prototype,"separateCells",void 0),Vi([ut({type:Boolean,attribute:"blank"})],Ki.prototype,"blank",void 0),Vi([ut({attribute:"type",type:String})],Ki.prototype,"type",null),Vi([ut({attribute:"is-editing",type:Boolean})],Ki.prototype,"isEditing",void 0),Vi([ut({attribute:"menu",type:Boolean})],Ki.prototype,"hasMenu",void 0),Vi([ut({attribute:"is-first-column",type:Boolean})],Ki.prototype,"isFirstColumn",void 0),Vi([ut({attribute:"is-last-column",type:Boolean})],Ki.prototype,"isLastColumn",void 0);var Yi=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let Zi=class extends Sr{get menuPositionClasses(){return"undefined"!=typeof window?"right-0 left-0 top-9":""}render(){const t=Mt({dark:this.theme==Oe.dark});return V`
        ...
        `}};rs([ut({type:Number,attribute:"height"})],os.prototype,"height",void 0),rs([ut({type:Object})],os.prototype,"column",void 0),os=rs([ct("column-resizer")],os);var is=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let ss=class extends Sr{get menuPositionClasses(){return"undefined"!=typeof window?"right-0 top-8":""}};ss=is([ct("astra-th-menu")],ss);var ns=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let as=class extends Ki{constructor(){super(...arguments),this.readonly=!0,this.withResizer=!1,this.installedPlugins={},this.options=[{label:"Sort A-Z",value:"sort:alphabetical:ascending"},{label:"Sort Z-A",value:"sort:alphabetical:descending"},{label:"Hide Column",value:"hide"},{label:"Rename Column",value:"rename"},{label:"Delete Column",value:"delete",classes:"text-red-500 dark:text-red-400/90 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10"}],this._previousWidth=0,this._options=[],this._pluginOptions=[]}classMap(){return{...super.classMap(),"table-cell relative whitespace-nowrap h-[38px]":!0,"cursor-pointer":!0,"border-b border-theme-border dark:border-theme-border-dark":!0,"first:border-l border-t":this.outerBorder,"px-cell-padding-x py-cell-padding-y":!0,"bg-theme-column dark:bg-theme-column-dark":!this.dirty,"bg-theme-cell-dirty dark:bg-theme-cell-dirty-dark":this.dirty,"select-none":this.hasMenu,"border-r":!this.withResizer&&this.isLastColumn&&this.outerBorder||!this.withResizer&&this.separateCells&&!this.isLastColumn}}get value(){return this._value?.toString()}set value(t){const e=this._value;this._value=t,this.requestUpdate("value",e)}get originalValue(){return this._originalValue?.toString()}set originalValue(t){const e=this._originalValue;this._originalValue=t,this.requestUpdate("value",e)}dispatchChangedEvent(){"string"==typeof this.originalValue&&this.dispatchEvent(new Ve({name:this.originalValue,data:{name:this.value}}))}onMenuSelection(t){t.stopPropagation();let e=!1;const r=this.originalValue??this.value??"",o=this.plugins?.find((({tagName:e})=>t.value===e));if(o)return this.dispatchEvent(new qe(r,{...o,columnName:r}));if("uninstall-column-plugin"===t.value){const t=this.installedPlugins[r];if(!t)throw new Error(`Attempting to uninstall a non-existent plugin on ${r}`);this.dispatchEvent(new Ke(r,t))}switch(t.value){case"hide":return this.hideColumn();case"rename":return this.isEditing=!0;case"delete":return this.removeColumn();case"reset":return this.dispatchEvent(new Ve({name:this.originalValue??"",data:{value:this.value}})),this.value=this.originalValue??"";default:e=!0}e&&this.dispatchEvent(new Ye({name:this.originalValue??this.value??"",data:{action:t.value}}))}onContextMenu(t){const e=this.shadowRoot?.querySelector("astra-th-menu");e&&(t.preventDefault(),e.focus(),e.open=!0)}onClick(t){const e=t.composedPath(),r=e.some((t=>"trigger"===t.getAttribute?.("id"))),o=this.originalValue??this.value,i=!e.some((t=>"column-resizer"===t.tagName?.toLowerCase()));!r&&o&&i&&this.dispatchEvent(new Ye({name:o,data:{action:"sort:alphabetical:ascending"}}))}removeColumn(){if(!this.originalValue)throw new Error("missing OG value");this.dispatchEvent(new We({name:this.originalValue}))}hideColumn(){if(!this.originalValue)throw new Error("missing OG value");this.dispatchEvent(new Fe({name:this.originalValue}))}connectedCallback(){super.connectedCallback(),this.addEventListener("contextmenu",this.onContextMenu),this.addEventListener("click",this.onClick)}disconnectedCallback(){super.disconnectedCallback,this.removeEventListener("contextmenu",this.onContextMenu),this.removeEventListener("click",this.onClick)}firstUpdated(t){this.width&&this.style&&(this.style.width=this.width)}willUpdate(t){if(super.willUpdate(t),t.has("plugins")){const t=this.plugins?.filter((t=>!t.isDefault))??[];this._pluginOptions=t.map((t=>({label:t.displayName,value:t.tagName})))??[]}t.has("width")&&this.width&&this.style&&(this.style.width=this.width),t.has("readonly")&&(this.readonly?this.options=[{label:"Sort A-Z",value:"sort:alphabetical:ascending"},{label:"Sort Z-A",value:"sort:alphabetical:descending"},{label:"Hide Column",value:"hide"},{label:"Delete Column",value:"delete",classes:"text-red-500 dark:text-red-400/90 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10"}]:this.options=[{label:"Sort A-Z",value:"sort:alphabetical:ascending"},{label:"Sort Z-A",value:"sort:alphabetical:descending"},{label:"Hide Column",value:"hide"},{label:"Rename Column",value:"rename"},{label:"Delete Column",value:"delete",classes:"text-red-500 dark:text-red-400/90 hover:text-red-600 dark:hover:text-red-400 hover:bg-red-50 dark:hover:bg-red-500/10"}]),(t.has("isFirstColumn")||t.has("isFirstColumn"))&&this.isFirstColumn&&this.setAttribute("first-cell","true")}render(){const t=this.originalValue??this.value??"",e=void 0!==this.installedPlugins?.[t]&&!this.installedPlugins?.[t]?.isDefaultPlugin,r=this.dirty?[...this.options,{label:V`Revert to <span class="pointer-events-none italic whitespace-nowrap">${this.originalValue}</span>`,value:"reset"}]:[...this.options];this._pluginOptions.length>0&&r.splice(2,0,e?{label:V`<span class="">Remove Plugin</span> `,value:"uninstall-column-plugin"}:{label:V`<div class="flex items-center justify-between">Plugins ${es(16)}</div>`,value:"plugins",options:this._pluginOptions});const o={"absolute top-0 bottom-0 right-0 left-0":!0,dark:this.theme==Oe.dark},i={dark:this.theme==Oe.dark};if(this.blank)return V`<div class=${Mt(o)}><slot></slot></div> `;{const t=this.isEditing?V`<input .value=${this.value} @input=${this.onChange} @keydown=${Ki.onKeyDown} class=${Mt({"z-[1] absolute top-0 bottom-0 right-0 left-0":!0,"bg-blue-50 dark:bg-blue-950 outline-none focus:ring-2 focus:ring-blue-300 dark:focus:ring-blue-700":!0,"px-cell-padding-x font-normal":!0})} @blur=${this.onBlur}></input>`:this.hasMenu?V`<astra-th-menu theme=${this.theme} .options=${r} @menu-selection=${this.onMenuSelection}
                  ...
                  ></span>`:V`<div class=${Mt(i)}><slot></slot>${t}</div>`}}};ns([ut({attribute:"table-height",type:Number})],as.prototype,"tableHeight",void 0),ns([ut({attribute:"with-resizer",type:Boolean})],as.prototype,"withResizer",void 0),ns([ut({attribute:"plugins",type:Array})],as.prototype,"plugins",void 0),ns([ut({attribute:"installed-plugins",type:Object})],as.prototype,"installedPlugins",void 0),ns([ut({attribute:"options",type:Array})],as.prototype,"options",void 0),ns([ut({attribute:"value",type:String})],as.prototype,"value",null),ns([ut({attribute:"original-value",type:String})],as.prototype,"originalValue",null),ns([pt()],as.prototype,"_previousWidth",void 0),ns([pt()],as.prototype,"_options",void 0),ns([pt()],as.prototype,"_pluginOptions",void 0),as=ns([ct("astra-th")],as);var ls=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let cs=class extends cr{classMap(){return{"table-header-group sticky z-[2] top-0":!0,...super.classMap()}}};cs=ls([ct("astra-thead")],cs);var ds=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};let hs=class extends cr{constructor(){super(...arguments),this.selected=!1,this.isHeaderRow=!1,this.new=!1}classMap(){return{"table-row group":!0,"text-theme-column-text dark:text-theme-column-text-dark":this.isHeaderRow,"bg-theme-row-new dark:bg-theme-row-new-dark":this.new&&!this.selected,"odd:bg-theme-row-odd dark:odd:bg-theme-row-odd-dark even:bg-theme-row-even dark:even:bg-theme-row-even-dark":!this.new&&!this.isHeaderRow&&!this.selected,"bg-theme-row-selected dark:bg-theme-row-selected-dark hover:bg-theme-row-selected-hover dark:hover:bg-theme-row-selected-hover-dark":this.selected&&!this.isHeaderRow,...super.classMap()}}willUpdate(t){super.willUpdate(t),t.has("selected")&&void 0!==t.get("selected")&&this.dispatchEvent(new Event("on-selection"))}};ds([ut({type:Boolean,attribute:"selected"})],hs.prototype,"selected",void 0),ds([ut({type:Boolean,attribute:"header",reflect:!0})],hs.prototype,"isHeaderRow",void 0),ds([ut({type:Boolean,attribute:"new"})],hs.prototype,"new",void 0),hs=ds([ct("astra-tr")],hs);var us=function(t,e,r,o){var i,s=arguments.length,n=s<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,r,o);else for(var a=t.length-1;a>=0;a--)(i=t[a])&&(n=(s<3?i(n):s>3?i(e,r,n):i(e,r))||n);return s>3&&n&&Object.defineProperty(e,r,n),n};const ps="undefined"!=typeof navigator&&navigator.userAgent.includes("Safari")?20:4;let gs=class extends cr{set data(t){this.rows=t}updateVisibleColumns(){this.visibleColumns=this.columns.filter((({name:t,status:e})=>e!==De.deleted&&-1===this.hiddenColumnNames.indexOf(t)&&-1===this.deletedColumnNames.indexOf(t)))}constructor(){super(),this.selectableRows=!1,this.keyboardShortcuts=!1,this.isNonInteractive=!1,this.outerBorder=!1,this.hiddenColumnNames=[],this.deletedColumnNames=[],this.renamedColumnNames={},this.pluginAttributes="",this.readonly=!1,this.blankFill=!1,this.columnWidthOffsets={},this.addableColumns=!1,this.scrollableEl=Gt(),this.rows=[],this.newRows=[],this.existingVisibleRows=[],this.allRowsSelected=!1,this.columns=[],this.visibleColumns=[],this.selectedRowUUIDs=new Set,this.removedRowUUIDs=new Set,this.rowHeight=38,this.visibleEndIndex=0,this.visibleStartIndex=0,this.fromIdToRowMap={},this._previousWidth=0,this.updateTableView=this.updateTableView.bind(this),this.onKeyDown=this.onKeyDown.bind(this)}addNewRow(t){const e={id:t?.id??self.crypto.randomUUID(),values:t?.values??{},originalValues:t?.originalValues??{},isNew:t?.isNew??!0};return this.rows=[...this.rows,e],this.dispatchEvent(new Xe(e)),e}addNewColumn(t){const e={is_nullable:!1,name:t,position:this.columns.length,model:"column",type:Te.TEXT,unique:!1,primaryKey:!1,autoIncrement:!1,status:De.created};this.columns=[...this.columns,e],this.rows=this.rows.map((e=>({...e,values:{...e.values,[t]:""}}))),this.dispatchEvent(new Be({name:t})),this.updateVisibleColumns()}toggleSelectedRow(t){const e=this.selectedRowUUIDs;e.has(t)?e.delete(t):e.add(t),this.requestUpdate("selectedRowUUIDs")}clearSelection(){this.selectedRowUUIDs=new Set,this.removedRowUUIDs=new Set,this.shadowRoot?.querySelectorAll(".row-select-checkbox").forEach((t=>{t.checked=!1,t.dispatchEvent(new Event("change"))}))}deleteSelectedRows(){this.selectedRowUUIDs.forEach((t=>this.removedRowUUIDs.add(t)));const t=[];this.selectedRowUUIDs.forEach((e=>{const r=this.rows.find((({id:t})=>e===t));r&&t.push(r)})),this.dispatchEvent(new Ge(t)),this.selectedRowUUIDs=new Set,this.requestUpdate("removedRowUUIDs")}resetParams(){this.clearSelection(),this.hiddenColumnNames=[]}_onColumnRemoved({name:t}){this.deletedColumnNames.push(t),this.requestUpdate("columns"),this.updateVisibleColumns()}_onColumnHidden({name:t}){this.hiddenColumnNames.push(t),this.requestUpdate("columns"),this.updateVisibleColumns()}_onRowSelection(){const t=[];this.selectedRowUUIDs.forEach((e=>{const r=this.fromIdToRowMap[e];r&&t.push(r)})),this.dispatchEvent(new Je(t))}widthForColumnType(t,e=0){const r=this.visibleColumns.find((({name:e})=>t===e))?.type?.toUpperCase();return[Te.BIGINT,Te.DECIMAL,Te.DECIMAL,Te.DOUBLE_PRECISION,Te.INTEGER,Te.NUMERIC,Te.REAL,Te.SMALLINT,Te.INT].includes(r)?150+e:[Te.CHAR,Te.TEXT,Te.VARCHAR,Te.VARYING].includes(r)?200+e:[Te.TIME,Te.DATE,Te.TIMESTAMP].includes(r)?110+e:[Te.TIME_WITH_TIME_ZONE,Te.DATETIME,Te.TIMESTAMP_WITH_TIME_ZONE].includes(r)||[Te.JSON,Te.JSONB].includes(r)?200+e:[Te.UUID].includes(r)?300+e:200+e}onKeyDown(t){const e=t.composedPath()[0];if(!(e instanceof HTMLElement&&"INPUT"!==e.tagName&&"TEXTAREA"!==e.tagName))return;const{shiftKey:r,key:o}=t;if(r){if("C"===o){const t=`Column ${Date.now()}`,e=prompt("Choose a unique name for this column",t)||t;this.addNewColumn(e)}"R"===o&&this.addNewRow(),"D"===o&&this.deleteSelectedRows()}}_onColumnResizeStart(){const t=this.shadowRoot?.getElementById("table");if(!t)throw new Error("Unexpectedly missing a table");this._previousWidth=t.clientWidth}_onColumnResized({delta:t}){const e=this.shadowRoot?.getElementById("table");if(!e)throw new Error("Unexpectedly missing a table");e.style.width=`${this._previousWidth+t}px`}_onColumnPluginDeactivated({column:t}){this.installedPlugins&&(delete this.installedPlugins[t],this.requestUpdate("installedPlugins"))}setCssVariablesForPlugin(t){"undefined"!=typeof document&&(t==Oe.dark?(document.documentElement.style.setProperty("--ob-background-color","#0A0A0A"),document.documentElement.style.setProperty("--ob-text-color","#D4D4D4"),document.documentElement.style.setProperty("--ob-border-color","#262626"),document.documentElement.style.setProperty("--ob-null-text-color","#959497")):(document.documentElement.style.setProperty("--ob-background-color","#FAFAFA"),document.documentElement.style.setProperty("--ob-text-color","#525252"),document.documentElement.style.setProperty("--ob-border-color","#E5E5E5"),document.documentElement.style.setProperty("--ob-null-text-color","#D0D0D0")),document.documentElement.style.setProperty("--ob-font-family",'"Inter", sans-serif'),document.documentElement.style.setProperty("--ob-cell-font-family",'"Inter", sans-serif'))}renderRows(t){return V`${gr(t,(({id:t})=>t),(({id:t,values:e,originalValues:r,isNew:o},i)=>this.removedRowUUIDs.has(t)?null:V`<astra-tr .selected=${this.selectedRowUUIDs.has(t)} ?new=${o} @on-selection=${this._onRowSelection}>
                          ...
                          ${gr(this.visibleColumns,(({name:t})=>t),(({name:s},n)=>{const a=this.plugins?.find((({pluginWorkspaceId:t})=>t===this.installedPlugins?.[s]?.plugin_workspace_id)),l=this.plugins?.find((({id:t})=>t===this.installedPlugins?.[s]?.plugin_installation_id)),c=a??l;return V`
                    ...
                    <astra-thead>
                        <astra-tr header>
                          ...
                          ${t}
                            ...
                            ${gr(this.visibleColumns,(({name:t},e)=>t),(({name:t},e)=>V`<astra-th
