...
/**
     ...
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
     */const We=(t,e,r)=>{const o=new Map;for(let i=e;i<=r;i++)o.set(t[i],i);return o},Ye=Ht(class extends Lt{constructor(t){if(super(t),t.type!==Mt)throw Error("repeat() can only be used in text expressions")}dt(t,e,r){let o;void 0===r?r=e:void 0!==e&&(o=e);const i=[],a=[];let s=0;for(const e of t)i[s]=o?o(e,s):s,a[s]=r(e,s),s++;return{values:a,keys:i}}render(t,e,r){return this.dt(t,e,r).values}update(t,[e,r,o]){const i=(t=>t._$AH)(t),{values:a,keys:s}=this.dt(e,r,o);if(!Array.isArray(i))return this.ut=s,a;const n=this.ut??=[],l=[];let c,d,h=0,p=i.length-1,u=0,b=a.length-1;for(;h<=p&&u<=b;)if(null===i[h])h++;else if(null===i[p])p--;else if(n[h]===s[u])l[u]=jt(i[h],a[u]),h++,u++;else if(n[p]===s[b])l[b]=jt(i[p],a[b]),p--,b--;else if(n[h]===s[b])l[b]=jt(i[h],a[b]),Ut(t,l[b+1],i[h]),h++,b--;else if(n[p]===s[u])l[u]=jt(i[p],a[u]),Ut(t,i[h],i[p]),p--,u++;else if(void 0===c&&(c=We(s,u,b),d=We(n,h,p)),c.has(n[h]))if(c.has(n[p])){const e=d.get(s[u]),r=void 0!==e?i[e]:null;if(null===r){const e=Ut(t,i[h]);jt(e,a[u]),l[u]=e}else l[u]=jt(r,a[u]),Ut(t,i[h],r),i[e]=null;u++}else Wt(i[p]),p--;else Wt(i[h]),h++;for(;u<=b;){const e=Ut(t,l[b+1]);jt(e,a[u]),l[u++]=e}for(;h<=p;){const t=i[h++];null!==t&&Wt(t)}return this.ut=s,((t,e=Bt)=>{t._$AH=e})(t,l),Y}});var Ve=function(t,e,r,o){var i,a=arguments.length,s=a<3?e:null===o?o=Object.getOwnPropertyDescriptor(e,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,r,o);else for(var n=t.length-1;n>=0;n--)(i=t[n])&&(s=(a<3?i(s):a>3?i(e,r,s):i(e,r))||s);return a>3&&s&&Object.defineProperty(e,r,s),s};const Ze=W`<svg
    aria-hidden="true"
...
>
    <path d="M213.66,101.66l-80,80a8,8,0,0,1-11.32,0l-80-80A8,8,0,0,1,53.66,90.34L128,164.69l74.34-74.35a8,8,0,0,1,11.32,11.32Z"></path>
        ...
        `],Ve([pt({attribute:"aria-expanded",reflect:!0})],Xe.prototype,"ariaExpanded",void 0),Ve([pt({attribute:"placeholder"})],Xe.prototype,"placeholder",void 0),Ve([pt({attribute:"value"})],Xe.prototype,"value",void 0),Ve([pt({attribute:"options",type:Array})],Xe.prototype,"options",void 0),Ve([pt({attribute:"disabled",type:Boolean})],Xe.prototype,"disabled",void 0),Ve([ut()],Xe.prototype,"isOpen",void 0),Ve([function(t,e){return(r,o,i)=>{const a=e=>e.renderRoot?.querySelector(t)??null;if(e){const{get:t,set:e}="object"==typeof o?r:i??(()=>{const t=Symbol();return{get(){return this[t]},set(e){this[t]=e}}})();return bt(r,o,{get(){let r=t.call(this);return void 0===r&&(r=a(this),(null!==r||this.hasUpdated)&&e.call(this,r)),r}})}return bt(r,o,{get(){return a(this)}})}}("#options-list")],Xe.prototype,"optionsListElement",void 0),Xe=Ve([ct("astra-select")],Xe);var qe=Xe;return t.AstraButton=kt,t.AstraCard=_t,t.AstraInput=zt,t.AstraLabel=Tt,t.AstraScrollArea=Be,t.AstraSelect=qe,t}({});
