...
export const TWStyles = css`
    /* DO NOT EDIT; THIS FILE IS GENERATED BY lib/tw-styles.ts ... This file yields the definitions for Tailwind classes used in out LitElements */
...
*/
    ...
    :host {
        ...
        tab-size: 4;
        /* 3 */
        font-family: Inter, Helvetica, ui-sans-serif, system-ui, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol',
            'Noto Color Emoji';
        /* 4 */
...
*/
    ...
    *,
    ...
    .bg-theme-cell-dirty-dark {
        background-color: var(--cell-dirty-background-color, rgba(234, 179, 8, 0.6));
    }
